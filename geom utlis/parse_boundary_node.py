def parse_and_filter_nodes(mesh_lines, x_value=None, y_value=None, z_value=None, tolerance=1e-10):
    """
...
#nodes_at_y0 = parse_and_filter_nodes(mesh_data, y_value=-0.0001)


#nodes_at_x10 = parse_and_filter_nodes(mesh_data, x_value=0.15)
#nodes_at_y10 = parse_and_filter_nodes(mesh_data, y_value=0.0001)
nodes_at_z10 = parse_and_filter_nodes(mesh_data, z_value=0.1)

# 3d
#nodes_union = list(set(nodes_at_x0) |  set(nodes_at_y0) | set(nodes_at_x10) | set(nodes_at_y10))
